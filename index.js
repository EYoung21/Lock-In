  ...
  const AppWrapper = () => {
    ...
    useEffect(() => {
      ...
      const unsubscribe = firebase.auth().onAuthStateChanged((user) => {
        if (user) {
          ...
          // AccountSync will handle syncing internally based on auth state
        } else {
          console.log('User is signed out');
          setIsUserLoggedIn(false);
          // AccountSync will handle clearing data internally
        }
      });
    ...
    return <FullApp isUserLoggedIn={isUserLoggedIn} />;
  };
